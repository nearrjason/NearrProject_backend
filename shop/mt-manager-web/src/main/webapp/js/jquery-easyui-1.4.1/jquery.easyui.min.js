...
_e2.dnd=false;
var _mt=$(_e1).find("div.tree-node");
_mt.draggable("disable");
_mt.css("cursor","pointer");
};
function _e4(_e5){
...
_2cb(_2e0,pp,_2e1);
_2a9(_2e0);
opts.onAdd.call(_2e0,_2e1.title,_2mt.length-1);
if(_2e1.selected){
_2d2(_2e0,_2mt.length-1);
}
};
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_5d1(true),mouseout:_5d1(false),click:_5d9,dblclick:_5mt,contextmenu:_5e7},rowStyler:function(_76a,_76b){
...
if(_7e1<_7mt.startIndex){
_7e1=_7mt.startIndex;
}else{
if(_7e1>_7mt.startIndex+_7mt.rows.length){
_7e1=_7mt.startIndex+_7mt.rows.length;
}
}
...
_7mt.rows.splice(_7e1-_7mt.startIndex,0,row);
}else{
_7mt={value:row[opts.groupField],rows:[row],startIndex:_7e2.data.rows.length};
_7e4=this.groups.length;
dc.body1.append(this.renderGroup.call(this,_7e0,_7e4,_7mt,true));
dc.body2.append(this.renderGroup.call(this,_7e0,_7e4,_7mt,false));
this.groups.push(_7mt);
