...
<div id="header">
  <div class="header_inner">
    <div class="logo">
		...
		<a name="sfbest_hp_hp_head_logo" href="http://192.168.1.100:8082" class="trackref logoleft">
		</a>
		<div class="logo-text">
    ...
    <div class="search">
      <form action="http://192.168.1.100:8085/search.html" id="searchForm" name="query" method="GET">
