					...
					<form id="checkoutCard" class="checkoutCard" onsubmit="return false">
						...
						<div class="card-logo">
							...
							<c:if test="${primaryCard.cardType eq 4 }">
								<img class="card-logo-img" src="/images_meitao/icons/visa.svg"
									alt="">
							</c:if>
							<c:if test="${primaryCard.cardType eq 5 }">
								<img class="card-logo-img"
									src="/images_meitao/icons/mastercard.svg" alt="">
							</c:if>
						...
						<div class="cvv">
							<input id="cvvInput" type="text" placeholder="CVV" maxlength="3">
							<p id="cvv_check" class="error_message"></p>
						</div>
