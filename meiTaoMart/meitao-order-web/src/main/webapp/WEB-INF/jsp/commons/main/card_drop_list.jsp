...
<div class="keep-parallel">
	<div class="cardinfo-show">
		<div class="info-display" id="card-drop">
			<div id="showPrimaryCard" class="show_primary_card">
				...
				<div class="wrapper">
					<form id="checkoutCard" class="checkoutCard" onsubmit="return false">
						...
						<div class="card-logo">
							<c:if test="${primaryCard.cardType eq 3 }">
								<img class="card-logo-img" src="/images/icons/amex.svg"
									alt="">
							</c:if>
							<c:if test="${primaryCard.cardType eq 4 }">
								<img class="card-logo-img" src="/images/icons/visa.svg"
									alt="">
							</c:if>
							<c:if test="${primaryCard.cardType eq 5 }">
								<img class="card-logo-img"
									src="/images/icons/mastercard.svg" alt="">
							</c:if>
							<c:if test="${primaryCard.cardType eq 6 }">
								<img class="card-logo-img"
									src="/images/icons/discover.svg" alt="">
							</c:if>
					...
					<div class="dropdown-arrow2">
						<img id="dropdown-img2" class="dropdown-img" onclick="selectCard()"
	...
	<!-- <div class="add-card">
		<img class="plus-img" src="/images/plus-symbol.svg" alt=""
			...
			<div class="btn-click" onclick="selectShippingCard(this, ${card.id})">
				<div class="keep-parallel">
					...
					<div class="card-num-info">
						...
						<br>
						<div class="card-info">
							持卡人 &nbsp; ${card.firstName}&nbsp ${card.lastName} <input
					...
					<c:if test="${card.isMain == null || card.isMain eq false }">
						<div class="card-default" style="float: right;"></div>
					</c:if>
