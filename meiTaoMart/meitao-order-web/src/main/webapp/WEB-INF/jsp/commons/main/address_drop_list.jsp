						...
						<form id="checkoutAddress" class="checkoutAddress"
							...
							<div class="info-phone-loc">
								...
								<div class="info-loc keep-parallel">
									<img class="loc-img" src="/images/location.svg" alt="">
								...
								<div class="zipc">
									<!-- <span><a href=""><img class="zipc-img" src="/images/location.svg" alt=""></a></span> -->
...
<div class="ship-option">
	<div class="address-drop">
		<!-- <img class="dropdown-img" onclick="selectShippingAddress()" src="/images/chevron-up.svg" alt=""> -->
		...
		<div class="info-display2">
			<c:forEach items="${addressList}" var="address"
				...
				<div class="addr1"
					...
					<div class="info-phone-loc">
						<div class="info-phone">
							<span><img class="phone-img"
								src="/images/phone.svg" alt=""></span> <span
						...
						<div class="info-loc">
							<span><img class="loc-img"
								src="/images/location.svg" alt=""></span> <span
					...
					<!-- <div class="edit-pen">
							<img class="pen-img" src="/images/edit.svg" alt="">
						</div> -->
