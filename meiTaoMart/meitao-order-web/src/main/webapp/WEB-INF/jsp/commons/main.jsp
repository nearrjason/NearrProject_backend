...
<section>
	<div class="main-display">
		...
		<div class="keep-parallel">
			<div class="maintab-display">
				...
				<div class="main">
					...
					<h3 class="customfont add" onclick="openNewAddressWindow()">
						<span>新增&nbsp;</span><img src="/images/icons/plus-symbol.svg"
							alt="" class="add-addr">
					</h3>
				...
				<div class="main">
					...
					<h3 class="customfont add" onclick="openNewCardWindow()">
						<span>新增&nbsp;</span><img src="/images/icons/plus-symbol.svg"
							alt="" class="add-pay">
					</h3>
					<div class="creditcard-pay">
						<!-- <input type="radio" name="paymethod" value="creditcart" onclick="chooseCreditPay()"> <img class="pay-img" src="/images/creditcard.svg">信用卡<br> -->
					...
					<!-- <div class="zhifubao-pay">
                                <input type="radio" name="paymethod" value="zhifubao" onclick="chooseZhifubaoPay()"> <img class="pay-img" src="/images/zhifubao.svg">支付宝<br>
                                <div class="zhifubao-list">
                                    
                                </div>
                            </div>
                            <div>
                                <input type="radio" name="paymethod" value="wechat" onclick="chooseWechatPay()"> <img class="pay-img" src="/images/wechat.svg">微信<br>  
				...
				<div class="back">
					<a href="http://192.168.1.100:8090/cart/cart.html"><img
						src="/images/icons/left-arrow.svg" alt="">返回购物车</a>
				</div>

				<div class="submit-form">
					<button class="submit-btn" onclick="showEnterCVV()">确认支付</button>
				</div>
			</div>
			...
			<div class="side-count container">
				...
				<div id="final_prices_block">
					<jsp:include page="main/final_prices_block.jsp" />
				</div>
			</div>
		</div>
		<div id="overlay"></div>
		...
		<!--pop up for cvv-->
		<div class="popup-box" id="enterCVV">
			...
			<div class="enter">
				...
				<div class="img-input">
					<div class="cvv-img">
						<img src="/images/icons/image-cvv.svg" alt="">
					</div>
					<div class="cvv-input">
						<label for="">cvv</label><br> <input id="cvvInput"
							type="text" value="" maxlength="3">
					</div>
				</div>
				<button class="pay-now" onclick="finalCheckout()">立即支付</button>
			</div>
			...
			<div class="success">
				<h2>您已支付成功，正在为您准备商品！</h2>
				<img src="/images/icons/pay-success.svg" alt=""
			...
			<div class="fail">
				<h2>支付失败</h2>
				<h1></h1>
				<img src="/images/icons/pay-fail.svg" alt="" class="status-fail">
				<div class="retry">
					<button id="failureButton" onclick="closePopup()">返回</button>
				</div>
			</div>
		</div>
