...
<head>
<title>${item.name }- 美桃商城</title>
<script>
        var _SF_CFG = {
	    www_url:'http://192.168.1.100:8082',
	...
	<div class="linknav">
		<div class="breadcrumb">
			<strong><a href="/food/6-0-0-0-0-2-0-0-0-0-0.html">休闲食品</a></strong><span>
				...
				href="http://192.168.1.100:8082/pinpai/7331-10863.html">我是花吃</a> &gt;
		...
		<div class="productIntro">
			<div class="pItems">
				<div class="pItemsMain">
					<div class="pItemsName">
						<div class="cm">
							<h1 id="base_name-sf">${item.name }</h1>
						...
						<div class="priceBox">
							<span class="dt">优选价：</span><span class="rmb">$</span> <strong
								class="price"><fmt:formatNumber groupingUsed="false"
									...
									value="${item.salePrice / 100 }" /></strong>
						</div>
						<div class="boxWb"></div>
						...
						<div class="dd">
							<div id="regionSf">
								<div class="" id="store-selector">
									<div class="text">
										<div title="827 S Carpenter St">827 S Carpenter St, Chicago, IL 60607</div>
										<b></b>
									</div>
							...
							<div class="phone_client phone_border">
								...
								<div class="phone_clientCode" style="display: none;">
									...
									jQuery('#qrcodeTableBig1').qrcode({
										render	: "table",
										text	: "http://192.168.1.100:8082/html/products/230/1600229585.html",
										width:"124",
										height:"124"
									});	
								</script>
				...
				<div class="pView">
					<div id="pView">
						<div id="zoom-jpg" class="jqzoom">
							<img alt="" width="330" height="330" src="${item.oneImage }"
								jqimg="${item.oneImage }" />
						</div>
						<div id="pic-list">
							...
							<div class="pic-items"
								...
								<ul
									...
									<c:forEach items="${item.oneImage }" var="image">
										<li style="float: left;"><img title="${item.name } "
											alt="${item.name }" src="${image }"></li>
									</c:forEach>
								</ul>
							</div>
						</div>
			...
			<div class="pItemsSide">
				...
				<div class="pdetail">
					<ul>
						<li>品牌：<span><a
								href="http://192.168.1.100:8082/pinpai/7331-10863.html" title="我是花吃"
	...
	<div class="pWrap">
			...
			<div class="pCont cpjs_box" id="div-detail">
				...
				<div class="pJiucuo">
					如果您发现商品信息存在问题，<a target="_blank"
						href="http://192.168.1.100:8082/ProductCorrection/ProductCorrection/pId/${item.id}"
						rel="nofollow">欢迎纠错</a>
				</div>
				<div class="product_info">${item.itemDesc }</div>
			</div>
							...
							<div class="pBtns">
								...
								<div>
									<a class="pbtn2" href="javascript:Goods.gotoPl()"
										...
										target="_blank"
										href="http://192.168.1.100:8082/html/article/140/133.html"
		...
		<div class="left-box">
			<div id="brandCon" class="catlist" style="">
				...
				<ul class="pClass">
					<li><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-10949.html#sfbest_item_1600229585_brand_1"
						title="半岛月饼">半岛月饼</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-3342.html#sfbest_item_1600229585_brand_2"
						title="元朗荣华">元朗荣华</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-2241.html#sfbest_item_1600229585_brand_3"
						title="奇华">奇华</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-6626.html#sfbest_item_1600229585_brand_4"
						title="迪士尼">迪士尼</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-10805.html#sfbest_item_1600229585_brand_5"
						title="宜芝多">宜芝多</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-9347.html#sfbest_item_1600229585_brand_6"
						title="日田食品">日田食品</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-10765.html#sfbest_item_1600229585_brand_7"
						title="欧美香" style="display: none;">欧美香</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-10853.html#sfbest_item_1600229585_brand_8"
						title="零食多" style="display: none;">零食多</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-10863.html#sfbest_item_1600229585_brand_9"
						title="我是花吃" style="display: none;">我是花吃</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-2696.html#sfbest_item_1600229585_brand_10"
						title="史努比 Snoopy" style="display: none;">史努比 Snoopy</a><a
						target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-3662.html#sfbest_item_1600229585_brand_11"
						title="郭元益" style="display: none;">郭元益</a><a target="_blank"
						href="http://192.168.1.100:8082/pinpai/7331-4986.html#sfbest_item_1600229585_brand_12"
				...
				<div class="cm">
					<ul class="l-buy" id="buyrebuy-sf">
						<li><div class="p-img">
							...
							<div class="title-a">
								<a target="_blank"
									href="http://192.168.1.100:8082/html/products/5/1800005691.html#trackref=sfbest_item_1600229585_buy1_1">归原Green
									Yard 有机鲜牛奶 486ml</a>
							</div>
				...
				<div class="cm">
					<ul class="l-buy" id="browserbrowse-sf">
						<li><div class="p-img">
							...
							<div class="title-a">
								<a target="_blank"
									href="http://192.168.1.100:8082/html/products/5/1800005691.html#trackref=sfbest_item_1600229585_see_1">归原Green
									Yard 有机鲜牛奶 486ml</a>
							</div>
							<div class="title-b">【下单后3-5天发货】外包装更换中，请以实物为准</div>
							<div class="p-price">$20</div></li>
