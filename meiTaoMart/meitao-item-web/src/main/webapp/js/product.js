...
(function(){
    ...
    //获取相关品牌
    Goods.brands = function(tcid, categoryId, callback) {
        Goods.ajaxPost({
            'url': '/goods/relateBrand/',
            'data' : {'categoryId': categoryId, 'categoryOne': tcid},
            'callback': callback
        });
    }
    ...
    //销售排行
    Goods.saleTop = function (categoryId, callback) {
        Goods.ajaxPost({
            'url': '/goods/saletop/',
    ...
    Goods.commentTpl = function(data) {
        ...
        if (commentsStr == '') {
            ...
            $(".comment-like-sf").click(function(){
                ...
                if (hasLiked == '0') {
                    $.post("/comments/addLike/", {'categoryId' : commentId}, function(r){
                        if (r.error == 2) {
