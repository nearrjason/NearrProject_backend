var CART = {
	itemNumChange : function(){
		$(".increment").click(function(){// ＋
			...
			var purchaseQuantity = eval(_thisInput.val());
			console.log(purchaseQuantity);
			console.log(_thisInput.attr("itemId"));
			$.post("/cart/update/purchaseQuantity/"+_thisInput.attr("itemId")+"/"+ purchaseQuantity + ".action",function(response){
				CART.refreshSingleTotalPrice(unitPrice, purchaseQuantity, index);
		...
		$(".decrement").click(function(){
			...
			_thisInput.val(eval(_thisInput.val()) - 1);
			$.post("/cart/update/purchaseQuantity/"+_thisInput.attr("itemId")+"/"+_thisInput.val() + ".action",function(response){
