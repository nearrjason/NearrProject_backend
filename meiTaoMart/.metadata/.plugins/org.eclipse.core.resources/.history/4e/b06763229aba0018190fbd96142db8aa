    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://192.168.1.100:8088/page/login" style="margin-right: 15px;">请登录</a>
	      	<a href="http://192.168.1.100:8088/page/register">免费注册</a>
      	</span>
      </li>
	  ...
	  <li class="menus">
        <a name="sfbest_hp_hp_head_help1" href="http://help.e3mall.cn/" target="_blank" class="trackref t">我的账户</a><b></b>
        <span class="outline"></span>
        <span class="blank"></span>
        <div class="dd">
          <div><a name="sfbest_hp_hp_head_help2" class="trackref" href="http://help.e3mall.cn/140/128.html" rel="nofollow" target="_blank"></a></div>
