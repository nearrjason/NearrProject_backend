...
<table class="easyui-datagrid" id="itemList" title="商品列表"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'categoryId',width:100,align:'center'">商品类型 id</th>
			...
			<th data-options="field:'salePrice',width:100,align:'center',formatter:E3.formatPrice"">商品单价($)</th>
			<th data-options="field:'cost',width:100,align:'center',formatter:E3.formatPrice"">商品成本($)</th>
