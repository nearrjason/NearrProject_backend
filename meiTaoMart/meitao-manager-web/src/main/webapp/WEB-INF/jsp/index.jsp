...
<title>美桃商城后台管理系统</title>
<link rel="stylesheet" type="text/css"
	href="js/jquery-easyui-1.4.1/themes/gray/easyui.css" />
<link rel="stylesheet" type="text/css"
...
<body class="easyui-layout">
	...
	<div data-options="region:'north',border:false"
		...
		<span class="northTitle">美桃商城后台管理系统</span> <span class="loginInfo">登录用户：admin&nbsp;&nbsp;姓名：管理员&nbsp;&nbsp;角色：系统管理员</span>
	</div>
		...
		<ul id="menu" class="easyui-tree"
			...
			<li><span>商品管理目录</span>
				<ul>
					...
					<li data-options="attributes:{'url':'item-category'}">商品分类管理</li>
