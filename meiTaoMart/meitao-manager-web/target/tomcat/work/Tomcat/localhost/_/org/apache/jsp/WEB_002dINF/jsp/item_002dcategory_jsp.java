 ...
 * Generated at: 2018-10-12 16:38:43 UTC
...
public final class item_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t</ul>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"itemCategoryMenu\" class=\"easyui-menu\" style=\"width: 120px;\"\r\n");
      ...
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\turl : '/item/category/list',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t// 新增节点\r\n");
      out.write("\t\t\t\t\t\t\t$.post(\"/item/category/create\", {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$.messager.alert('提示', '创建 ' + node.text\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ ' 分类失败!');\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t$.post(\"/item/category/update\", {\r\n");
      ...
      out.write("\t\t\t$.messager.confirm('确认', '确定删除名为 ' + node.text + ' 的分类吗？',\r\n");
      out.write("\t\t\t\t\tfunction(r) {\r\n");
      out.write("\t\t\t\t\t\tif (r) {\r\n");
      out.write("\t\t\t\t\t\t\t$.post(\"/item/category/delete/\", {\r\n");
      out.write("\t\t\t\t\t\t\t\tid : node.id\r\n");
      out.write("\t\t\t\t\t\t\t}, function(data) {\r\n");
      out.write("\t\t\t\t\t\t\t\tif (data.status != null && data.status == 200) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttree.tree(\"remove\", node.target);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$.messager.alert('提示', '刪除 ' + node.text\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ ' 分类成功！');\r\n");
      out.write("\t\t\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$.messager.alert('提示', '刪除 ' + node.text\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ ' 分类失败: ' + data.msg);\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
