...
bb.num=$("<input class=\"pagination-num\" type=\"text\" value=\"10\" size=\"2\">").appendTo(tr).wrap("<td></td>");
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,1000],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_29,_2a){
