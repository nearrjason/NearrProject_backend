...
public class CartItemBuilder {
	...
	public CartItem build() {
		...
		cartItem.setPurchaseQuantity(this.purchaseQuantity);
		cartItem.setOneImage(this.oneImage);
	...
	public static CartItem getCartItem(ItemInfo itemInfo, Integer purchaseQuantity) {
		CartItem cartItem = cartItemBuilder.setId(itemInfo.getId()).setName(itemInfo.getName()).setSalePrice(itemInfo.getSalePrice())
				.setNetWeight(itemInfo.getNetWeight()).setImages(itemInfo.getImages()).setOneImage(itemInfo.getImages()).setPurchaseQuantity(purchaseQuantity).build();
